    ...
    <script type="text/javascript">
       ...
       /* $(function(){
            ...
            $("#captchaImage").click(function(){//点击更换验证码
                document.getElementById("captchaImage").src="/code/code?a="+Math.random();
            });
        });*/
    </script>
</head>
    ...
    <form id="loginForm" action="${pageContext.request.contextPath}/User/login" method="post" >
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <input type="text"  name="phoneNum" class="text" value="陈" maxlength="20"/>
                </td>
            </tr>
            <tr>
                <th>
                ...
                <td>
                    <input type="password" name="password" class="text" value="123" maxlength="20" autocomplete="off"/>
                </td>
            </tr>
